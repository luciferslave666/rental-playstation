...
// 1. Import tipe Konsol dan ubah RuanganAdminData
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 text-gray-700">
      ...
      <div>
        ...
        <input type="number" value={tarifPerJam} onChange={(e) => setTarifPerJam(parseFloat(e.target.value))} required className="w-full p-2 border border-gray-300 rounded-md" />
      </div>
      <div>
